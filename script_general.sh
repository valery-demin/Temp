...
curl -O http://archives.oclint.org/releases/0.7/oclint-0.7-x86_64-apple-darwin-10.tar.gz > /dev/null
tar -zxvf oclint-0.7-x86_64-apple-darwin-10.tar.gz > /dev/null
